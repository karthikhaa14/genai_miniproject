...
with st.sidebar:
    ...
    # for source, chat_entries in st.session_state.chat_history[-10:]:
    #     with st.sidebar.expander("View Chat History"):
    #         for entry in chat_entries:
    #             st.write(entry)
    with st.sidebar.expander("View Chat History"):
        for chat_entry in st.session_state.chat_history[-10:]:
            st.write(chat_entry)  # Just display each chat entry correctly
